  ...
  return (
    <StyledPolitica>
      ...
      <p className="">A Upcare Medical Center, com sede na estrada Nacional 109, n.o 167
        ...
        respetivos serviços no website publicados. O utilizador deve consultar
        periodicamente a página destes Termos e condições de utilização e Política
        de Privacidade para confirmar se foram efetuadas quaisquer atualizações ou
        alterações. Caso não concorde com alguma destas não deve utilizar o
        presente Website.</p>
        <br />
      <p className="bold">Utilização do Website</p>
      <p className="">Os Utilizadores que visitam o Website podem aceder e ler todo o conteúdo
        contido no mesmo, sem necessidade de registar dados ou informações
        pessoais. No entanto, apenas os utilizadores registados ou com a submissão
      ...
      <ul>
        <li>
          <p className="">Por qualquer razão ou finalidade que seja ilegal, difamatória, ofensiva,
            prejudicial, abusiva, invasiva da privacidade de outrem ou censurável;</p>
        </li>
        <li>
          <p className="">De forma que possa prejudicar ou interromper este Website ou
            qualquer um dos nossos serviços, ou a utilização pacífica por parte de
            outros utilizadores;</p>
        </li>
        <li>
          <p className="">Para transmitir vírus ou outra codificação maliciosa que possam
            danificar ou perturbar equipamento ou sistema informático (hardware
        ...
        <li>
          <p className="">Para promover qualquer tipo de atividade comercial, ou enviar ou
            disponibilizar informação ou conteúdos que pertencem a terceiros e
            que não tem o direito de utilizar, como, por exemplo, conteúdos
            protegidos por direitos de autor de terceiros ou conteúdos que
            contenham dados pessoais de terceiros.</p>
        </li>
      </ul>
      ...
      <p className="">Todos os conteúdos e informações publicados no presente website são da
        ...
        manter. Depois de ter carregado o conteúdo, pode optar por excluir o
      ...
      <p className="">É permitido o registo de dados de todos os utilizadores interessados em
        ...
        Para se registar como utilizador interessado em determinado serviço deve
        preencher o formulário e selecionar o pretendido: marcação ou pedido de
        informação.
        Os dados pessoais de cada utilizador serão mantidos enquanto a subscrição
        e/ou pedidos do utilizador estiverem ativos, com o objetivo de melhorar os
        serviços oferecidos, pelo que após a sua caducidade serão
      ...
      <p className="">A Upcare não é responsável, por perdas ou danos diretos, indiretos ou
        ...
        implícitas, encargos ou avais, representações e outros termos e condições
        de qualquer tipo relacionada com este Website ou matéria não contida
        nestes Termos e Condições estão expressamente excluídas.
        Nada nestes Termos de Utilização exclui, restringe ou modifica qualquer
        direito ou recurso, ou quaisquer garantias, ou outro termo ou condição,
        implícita ou impostas por qualquer legislação que não possam ser
        legalmente excluídas ou limitadas. Isso pode incluir a legislação referente
        aos direitos do Consumidor, em território Português, que contém garantias
        que protegem os Consumidores de bens e serviços em determinadas
        circunstâncias.
        A responsabilidade de uma parte para com outra parte é reduzida na medida
        em que os atos ou omissões da outra parte, ou aqueles de uma terceira
        parte, contribuem para ou causam tal responsabilidade.
        Apesar de desenvolvermos as correspondentes ações para manter este
        Website livre de vírus informáticos ou outra codificação danosa, não
        podemos garantir que este seja o caso. Deverá, portanto, utilizar um software
        de segurança, atualizado a todo o tempo, para proteger o seu computador de
        tais softwares maliciosos.
        Apesar de desenvolvermos todos os esforços comerciais razoáveis para
        ...
        Todos os utilizadores podem navegar neste website sem a obrigatoriedade
        de efetuar ou submeter qualquer registo de dados. Quando submete os seus
        dados, caso pretenda receber novidades, campanhas ou outros associados
        aos nossos serviços pedimos que concorde com o envio da mesma.
        O fornecimento de dados pessoais apenas é necessário no caso de
        pretender efetuar uma marcação de consulta, um pedido de informações ou
      ...
      <br />
      <p className="bold">Registo de dados</p>
      <p className="">Recolhemos informação pessoal, via o preenchimento voluntário dos devidos
        formulários dispostos para marcação de consultas, pedidos de informações
        ou serviços e pedidos de contacto.
        Ao contactar-nos através de e-mail, subscrever informações grátis, obriga-nos à recolha do seu endereço de e-mail, nome e outros dados específicos
        de identificação pessoal, traduzidos normalmente pelo nome e número de
        contacto.
        Ao pedir dados pessoais sensíveis, assegurar-nos-emos que a sua recolha e
        utilização será feita no rigoroso cumprimento da legislação aplicável à
        recolha e proteção de dados. Se pretendermos utilizar os seus dados
        pessoais para além dos fins estabelecidos inicialmente, pediremos o seu
        consentimento. Poderá escolher antecipadamente dar esse consentimento
        aquando da recolha inicial de dados.</p>
      <br />
      <p className="bold">Dados recolhidos automaticamente</p>
      <p className="">Os domínios e endereços de IP dos visitantes são registados
        automaticamente. Esta informação não identifica o utilizador, mas apenas o
        computador utilizado no acesso ao site. Estes dados são analisados a nível
        global para verificar em que local do mundo é que o site está a ser utilizado,
        de forma a assegurar a sua cobertura, permitindo que o nosso serviço ao
        utilizador possa ser melhorado. Os dados pessoais de cada utilizador não
        são objeto de recolha e análise neste processo.</p>
      <br />
      <p className="bold">Retenção de dados</p>
      <p className="">Os dados serão mantidos enquanto a subscrição do utilizador estiver ativa,
        com o objetivo de melhorar os serviços oferecidos, pelo que após a sua
        caducidade serão despersonalizados e não identificáveis. Apenas serão
        recolhidas informações adicionais acerca do utilizador para além das
        mencionadas acima caso surja necessidade de se obter mais informações
        clínicas.</p>
      <br />
      ...
      <p className="">Para solicitar esclarecimentos acerca do acesso aos dados pessoais, ou
        ...
        este site; para este fim, ser-lhe-á exigida uma prova de identificação. É-lhe
        permitido questionar os dados e, onde apropriado, poderá: apagar os dados,
        retificá-los, emendá-los ou completá-los. Reservamo-nos ao direito de recusa
        de fornecimento da cópia dos dados pessoais do utilizador, obrigando-nos a
        apresentar uma justificação para essa decisão. O utilizador poderá contestar
        a nossa decisão de recusa de fornecimento de cópia com os seus dados
        pessoais.</p>
      <br />
      <p className="bold">Revelação e escolha do visitante</p>
      ...
      <br />
      <p className="bold">Segurança</p>
      <p className="">Foram implementadas políticas de segurança, regras e medidas técnicas
        para proteger os dados pessoais sob o nosso controlo, que estão
        inteiramente de acordo com a legislação de proteção de dados, apropriada à
        jurisdição aplicável ao site. As medidas de segurança estão desenhadas para
        prevenir acessos não autorizados, utilizações impróprias, modificações não
        autorizadas e destruições ou perdas acidentais ilícitas.</p>
      <br />
      <p className="bold">Cumprimento/conformidade de privacidade</p>
      <p className="">A nossa política de privacidade está de acordo com a legislação portuguesa
...
const StyledPolitica = styled.div`
  ...
  .title{
    color: #231f20;
    font-size: calc(17px + 21 * (100vw - 300px) / 1620);
    line-height: 33px;
    position: relative;
    margin: 2.5em 0;
    letter-spacing: 6px;
  ...
  p{
    font-size: calc(11px + 12 * (100vw - 300px) / 1620);

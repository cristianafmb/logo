      ...
      {!breakpoints.mobile ? (
        <>
          ...
          <div className="no-repeat bg-position-bottom bg-cover" style={{ backgroundImage: `url(${background})` }}>
            ...
            <SubPage data={data.examesanalisesJson} subpage={data.examesanalisesJson.subpages.analisesclinicas} page="examesanalises" form={data.marcacaoJson} />
        ...
        (
          <>
            <SubPageMobile
               ...
               subpage={data.examesanalisesJson.subpages.analisesclinicas}
               page="especialidades"
...
export default AnalisesClinicas

export const Json = graphql`
query analisesclinicas {
  homeJson {
    home {
      head
      subject

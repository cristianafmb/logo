      ...
      {!breakpoints.mobile ? (
        <>
          ...
          <div className="no-repeat bg-position-bottom bg-cover" style={{ backgroundImage: `url(${background})` }}>
            ...
            <SubPage data={data.examesanalisesJson} subpage={data.examesanalisesJson.subpages.espirometria} page="examesanalises" form={data.marcacaoJson} />
        ...
        (
          <>
            <SubPageMobile
               ...
               subpage={data.examesanalisesJson.subpages.espirometria}
               page="especialidades"

      ...
      {!breakpoints.mobile ? (
        <>
          ...
          <div className="no-repeat bg-position-bottom bg-cover" style={{ backgroundImage: `url(${background})` }}>
            ...
            <SubPage data={data.examesanalisesJson} subpage={data.examesanalisesJson.subpages.polissonografia} page="examesanalises" form={data.marcacaoJson} />
        ...
        (
          <>
            <SubPageMobile
              ...
              subpage={data.examesanalisesJson.subpages.polissonografia}
              page="especialidades"
...
export default Polissonografia

export const Json = graphql`
query polissonografia {
  homeJson {
    home {
      head
      subject

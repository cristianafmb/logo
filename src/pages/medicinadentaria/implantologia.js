...
{!breakpoints.mobile ? (
    ...
    <div className="no-repeat bg-position-bottom bg-cover" style={{ backgroundImage: `url(${background})` }}>
      ...
      <SubPage data={data.medicinadentariaJson} subpage={data.medicinadentariaJson.subpages.implantologia} page="especialidades" form={data.marcacaoJson} />
        ...
        (
          <>
            <SubPageMobile
              ...
              subpage={data.medicinadentariaJson.subpages.implantologia}
              page="especialidades"

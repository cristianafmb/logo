...
const Psicologia = ({ data }) => {
  ...
  <Layout home mobile={useBreakpoint().mobile}>
    ...
    <div className="no-repeat bg-position-bottom bg-cover" style={{ backgroundImage: `url(${data.especialidadesJson.backgroundtop})` }}>
      ...
      <SubPage data={data.especialidadesJson} subpage={data.especialidadesJson.subpages.psicologia} page="especialidades" form={data.marcacaoJson} />
        ...
        (
          <>
            <SubPageMobile
              ...
              subpage={data.especialidadesJson.subpages.psicologia}
              page="especialidades"
